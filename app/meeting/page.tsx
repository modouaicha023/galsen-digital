      ...
      <div className="md:px-0 px-6 xl:w-4/5 2xl:w-[68%] justify-between md:mt-14 md:flex mx-auto  ">
        <div className="md:w-2/5">
          ...
          <p className="text-lg text-gray-500 py-4">
            Nous sommes toujours ravis de rencontrer de nouvelles personnes et
            de discuter de nouveaux projets. N&apos;hésitez pas à prendre
          ...
          {[
            ...
            },
            {
              ...
              description:
                "Obtenez des conseils d'experts sur la façon d'améliorer votre entreprise et d'augmenter votre présence en ligne.",
            },
            {
